    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('arrive', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='arrive', to='starvato_airlines.airport')),
                ('start', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='start', to='starvato_airlines.airport')),
            ],
        ),
        migrations.CreateModel(
            name='Booking',
